        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteOption = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSalary = table.Column<decimal>(nullable: false),
                    MaxSalary = table.Column<decimal>(nullable: false),
                    OptionalStartDate = table.Column<DateTime>(nullable: true),
                    Location = table.Column<string>(nullable: true),
                    CurrentNumberOfEmployees = table.Column<int>(nullable: true),
                    IndustryId = table.Column<int>(nullable: false),
                    PositionStatusOpen = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
